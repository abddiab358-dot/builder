              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    className="w-full border border-slate-300 dark:border-slate-600 rounded-lg px-3 py-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-50 focus:outline-none focus:ring-2 focus:ring-primary-500"
                    value={newUserRole}
                    onChange={(e) => setNewUserRole(e.target.value as 'manager' | 'staff' | 'viewer' | 'supervisor')}
                  >
                    <option value="manager">مدير (تحكم كامل)</option>
                    <option value="supervisor">رئيس ورشة (مشرف)</option>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <select
                          ...
                          value={u.role}
                          onChange={(e) => updateUserRole(u.id, e.target.value as 'manager' | 'staff' | 'viewer' | 'supervisor')}
                        >
                          <option value="manager">مدير</option>
                          <option value="supervisor">رئيس ورشة</option>
              ...
              <>
                ...
                <div className="flex flex-col items-center gap-4 mb-6">
                  <button
                    ...
                    disabled={isSyncing}
                    className="w-full md:w-auto p-6 rounded-lg border-2 border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex flex-col items-center"
                  >
                    <div className="flex items-center justify-center gap-3 mb-3">
                      ...
                      <span className="font-bold text-lg text-slate-900 dark:text-slate-50">ربط مجلد Google Drive</span>
                    </div>
                    <p className="text-sm text-slate-600 dark:text-slate-400 text-center max-w-sm">
                      اختر مجلد Google Drive المحلي على جهازك ليتم حفظ النسخ الاحتياطية فيه مباشرةً، مما يضمن المزامنة التلقائية مع السحابة.
                    </p>
                  </button>
                </div>
